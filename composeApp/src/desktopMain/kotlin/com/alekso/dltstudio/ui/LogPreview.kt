        ...
        if (dltMessage != null) {
            ...
            if (dltMessage.payload != null) {
                ...
                Row(modifier = paddingModifier) {
                    MonoText(modifier = Modifier.width(20.dp).padding(end = 1.dp).background(color = Color(250, 250, 250)), text = "#")
                    MonoText(modifier = Modifier.width(120.dp).padding(end = 1.dp).background(color = Color(250, 250, 250)), text = "type")
                    MonoText(modifier = Modifier.width(40.dp).padding(end = 1.dp).background(color = Color(250, 250, 250)), text = "size")
                    MonoText(modifier = Modifier.weight(1f).padding(end = 1.dp).background(color = Color(250, 250, 250)), text = "payload")
                }
                payload.arguments.forEachIndexed { index, it ->
                    Row(modifier = paddingModifier) {
                        MonoText(modifier = Modifier.width(20.dp).padding(end = 1.dp).background(color = Color(250, 250, 250)), text = "$index")
                        MonoText(modifier = Modifier.width(120.dp).padding(end = 1.dp).background(color = Color(250, 250, 250)), text = it.typeInfo.getTypeString())
                        MonoText(modifier = Modifier.width(40.dp).padding(end = 1.dp).background(color = Color(250, 250, 250)), text = "${it.payloadSize}")
                        MonoText(modifier = Modifier.weight(1f).padding(end = 1.dp).background(color = Color(250, 250, 250)), text = it.getPayloadAsText())
                    }
                }
            }
        }

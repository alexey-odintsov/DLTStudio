...
# Features
- Logs view screen
  - Plain text and regex search by Payload
  ...
  - Logs word wrapping
  - Rectangles/Views preview in Virtual devices
- Timeline screen
  - Zoomable and movable timeline
  - Custom timeline views that are generated by regexp: Percentage, MinMax, State/SingleState, Duration and Events views
